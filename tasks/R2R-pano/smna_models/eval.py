...
import smna_models.utils
from smna_models.utils import load_datasets, load_nav_graphs
from smna_models.follower import BaseAgent

#import smna_models.train
...
class Evaluation(object):
    ...
    def __init__(self, splits, dataset_name):
        ...
        self.scans = []
        self.instructions = {}
        for item in load_datasets(splits, dataset_name=dataset_name):
